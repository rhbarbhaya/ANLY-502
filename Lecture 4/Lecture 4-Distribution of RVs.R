...
download.file("http://www.openintro.org/stat/data/bdims.RData", destfile = "bdims")
load("bdims")
...
hist(mdims$hgt, main = "Histogram of Men's Heights", xlab = "Height in cm")
hist(fdims$hgt, main = "Histogram of Women's Heights", xlab = "Height in cm")
...
fwgtsd = sd(fdims$wgt)
hist(fdims$wgt, main = "Histogram of Women's Weight", xlab = "Weight in kg")
x = 40:90
y = dnorm(x, mean = fwgtmean, sd = fwgtsd)
lines(x, y, col = 'blue')
qqnorm(fdims$wgt)
qqline(fdims$wgt)
qqnormsim(fdims$wgt)
...
pnorm(180, mean = fhgtmean, sd = fhgtsd) - pnorm(175, mean = fhgtmean, sd = fhgtsd)
pnorm(50, mean = fwgtmean, sd = fwgtsd) - pnorm(45, mean = fwgtmean, sd = fwgtsd)
...
hist(rnorm(fdims$bii.di), main = "Histogram of Female Pelvic Diameter", xlab = "diameter")
qqnorm(fdims$bii.di)
qqline(fdims$bii.di)
 
# b. The histogram for female elbow diameter ( elb.di ) belongs to normal probability plot letter ____.
hist(rnorm(fdims$elb.di), main = "Histogram of Female Elbow Diameter", xlab = "diameter of elbow")
qqnorm(fdims$elb.di)
qqline(fdims$elb.di)

# c. The histogram for general age ( age ) belongs to normal probability plot letter ____.
hist(rnorm(fdims$age), main = "Histogram of Female Age", xlab = "Age")
qqnorm(fdims$age)
qqline(fdims$age)

# d. The histogram for female chest depth ( che.de ) belongs to normal probability plot letter ____.
hist(rnorm(fdims$che.de), main = "Histogram of Women's Chest Depth", xlab = "Depth")
qqnorm(fdims$che.de)
qqline(fdims$che.de)
...
hist(fdims$kne.di, main = "Normalized Histogram for Female Knee", xlab = "diameter")
